...
// Address: 0x1d79e0 - 0x1d79f0
void sub_001D79E0_0x1d79e0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("sub_001D79E0_0x1d79e0");
#endif

    ctx->pc = 0x1d79e0u;

    // 0x1d79e0: 0x3c02006f  lui         $v0, 0x6F
    ctx->pc = 0x1d79e0u;
    SET_GPR_S32(ctx, 2, (int32_t)((uint32_t)111 << 16));
    // 0x1d79e4: 0x3e00008  jr          $ra
    ctx->pc = 0x1D79E4u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1D79E8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1D79E4u;
            // 0x1d79e8: 0x8c42a140  lw          $v0, -0x5EC0($v0) (Delay Slot)
